...
def ventana1(idProductor):
	...
	botBuscar = tk.Button(barraherr, image=iconBuscar, compound="top", backgroun="#b3f2bc", command=guardar)
	botImprimir = tk.Button(barraherr, image=iconImprimir, compound="top", backgroun="#f2f0b3", command = borrar)
	botExcel = tk.Button(barraherr, image=iconExcel, compound="top", backgroun="#f2f0b3", command = editar)
